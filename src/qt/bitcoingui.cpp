...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About RDCT"), this);
    aboutAction->setStatusTip(tr("Show information about RDCT"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the RDCT help message to get a list with possible RDCT command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("RDCT client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("RDCT"); // default title
