...
#   c) node1 mines 32 blocks, so now node 0 has 500000RDCT, node 1 has 4250RDCT, node2 has none.
#   d) node0 sends 601 RDCT to node2, in two transactions (301 RDCT, then 300 RDCT).
