Contributing to RDCT
==================================

The RDCT project operates an open contributor model where anyone is
...
The following applies to code changes to the RDCT project, and is not to be
confused with overall RDCT Network Protocol consensus changes.

Whether a pull request is merged into RDCT rests with the project merge
...
The project leader is the release manager for each RDCT release.
