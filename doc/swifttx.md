...
* WebSocket: [https://github.com/rdct/insight-api-rdct#web-socket-api](https://github.com/rdct/insight-api-rdct#web-socket-api)
* API: [https://github.com/rdct/insight-api-rdct#swifttx-transactions](https://github.com/rdct/insight-api-rdct#swifttx-transactions)
...
By default, the RDCT daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the RDCT daemon:
