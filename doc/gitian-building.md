...
```bash
    ...
    From https://github.com/rdct/rdct
...
For example:
```bash
URL=https://github.com/konez2k/rdct.git
...
[rdct/gitian.sigs](https://github.com/rdct/gitian.sigs/) repository, or if that's not possible to create a pull
request.
