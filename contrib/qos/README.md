...
This means one can have an always-on rdctd instance running, and another local rdctd/rdct-qt instance which connects to this node and receives blocks from it.
